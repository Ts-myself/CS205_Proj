...
bool Level::load_level(const std::string &level_path, std::vector<Level *> &internal_levels_,
                       std::vector<Box *> &boxes_, Player &player_, std::vector<std::string> &level_infos) {
    ...
    for (auto internal_level: internal_levels_) {
        delete internal_level;
    }
...
bool Level::load_level_by_info(const std::vector<std::string> &level_info, std::vector<Level *> &internal_levels_,
